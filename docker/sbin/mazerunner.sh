...
sudo su root -c -l "java -cp $CLASSPATH org.mazerunner.core.messaging.Worker --spark.master $SPARK_HOST --hadoop.hdfs $HDFS_HOST --spark.driver.host $DRIVER_HOST --spark.executor.memory $SPARK_EXECUTOR_MEMORY"
